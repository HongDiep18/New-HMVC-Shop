...
<head>
    ...
    <link rel="stylesheet" href="<?php echo PATH_URL; ?>admin/themes/plugins/light-gallery/css/lightgallery.css">
    <!-- Custom Css -->
...
<body class="theme-blush">
    ...
    <!-- Jquery Core Js -->
    <script src="<?php echo PATH_URL; ?>admin/themes/bundles/libscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js -->
    <script src="<?php echo PATH_URL; ?>admin/themes/bundles/vendorscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js -->
    <script src="<?php echo PATH_URL; ?>admin/themes/plugins/light-gallery/js/lightgallery-all.min.js"></script> <!-- Light Gallery Plugin Js -->
    <script src="<?php echo PATH_URL; ?>admin/themes/bundles/mainscripts.bundle.js"></script><!-- Custom Js -->
    <script src="<?php echo PATH_URL; ?>admin/themes/js/pages/medias/image-gallery.js"></script>
</body>
